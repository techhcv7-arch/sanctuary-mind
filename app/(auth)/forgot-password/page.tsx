...
export default function ForgotPasswordPage() {
  ...
  return (
    <div className="monolith-plate reveal-up reveal-up-1 p-8">
      <Link
        href="/login"
        className="mb-5 flex items-center gap-1.5 font-sans text-[0.78rem] text-[#2a3f6b]/70 hover:text-[#0d1f3c] transition"
      >
      ...
      {sent ? (
        <div className="text-center">
          <div className="mb-4 mx-auto grid h-14 w-14 place-items-center bg-[#0d1f3c]/10">
            <span className="font-display text-2xl">✉</span>
          </div>
          <h1 className="heading-engraved font-display text-[1.5rem] font-semibold tracking-tight text-[#0d1f3c] mb-3">
            Check your inbox
          </h1>
          ...
          <p className="font-sans text-[0.78rem] text-[#2a3f6b]/60">
            Didn&apos;t receive it? Check your spam folder or{" "}
            <button
              type="button"
              onClick={() => setSent(false)}
              className="text-[#0d1f3c] hover:underline font-medium"
            >
              try again
            </button>
            .
        ...
        <>
          ...
          <form onSubmit={handleSubmit} className="space-y-4">
            <div className="space-y-1.5">
              <label htmlFor="fp-email" className="block font-sans text-[0.78rem] font-medium text-[#2a3f6b]">
                Email address
              </label>
              <input
                id="fp-email"
